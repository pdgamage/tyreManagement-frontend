            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p><span className="font-medium">Status:</span> {request.status === 'pending' ? 'Pending' : request.status === 'complete' ? 'Engineer Approved' : request.status === 'Engineer Approved' ? 'Engineer Approved' : (request.status || '-')}</p>
