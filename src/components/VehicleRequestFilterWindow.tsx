...
const VehicleRequestFilterWindow: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg max-w-2xl mx-auto mt-8">
      <h2 className="text-2xl font-bold mb-4">Vehicle Request Filter</h2>
      <div className="mb-4">
        <label className="block mb-2 font-semibold">Vehicle Number</label>
        <input
          type="text"
          value={query}
        ...
        {suggestions.length > 0 && (
          <ul className="border bg-white rounded shadow mt-1 max-h-40 overflow-y-auto">
            {suggestions.map((sug) => (
              <li
                key={sug}
...
export default VehicleRequestFilterWindow;
