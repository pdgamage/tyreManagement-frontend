        ...
        <div className="relative max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-3/5 lg:w-2/3 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-blue-100 mb-6 md:mb-8">
              Streamline your fleet's tire management with our comprehensive
              solution
            </p>
      ...
      <section className="py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all transform hover:-translate-y-1 card-transition"
            >
